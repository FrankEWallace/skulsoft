                    ...
                    <table role="presentation" border="0" cellpadding="0" cellspacing="0">
                        <tr>
                            <td class="content-block">
                                <img style="max-height: 60px;" src="{{ config('config.assets.icon') }}">
                            </td>
                            <td class="content-block">
                                <div class="header">
                                    ...
                                    @if (config('config.social_network.facebook'))
                                        <span class="text-center menu-item">
                                            <a href="{{ config('config.social_network.facebook') }}">
                                                <img src="{{ url('/images/brand/facebook.png') }}"
                                                    class="footer-icon" />
                                            </a>
                                        </span>
                                    @endif
                                    ...
                                    @if (config('config.social_network.linkedin'))
                                        <span class="text-center menu-item">
                                            <a href="{{ config('config.social_network.linkedin') }}">
                                                <img src="{{ url('/images/brand/linkedin.png') }}"
                                                    class="footer-icon" />
                                            </a>
                                        </span>
                                    @endif
                                    @if (config('config.social_network.youtube'))
                                        <span class="text-center menu-item">
                                            <a href="{{ config('config.social_network.youtube') }}">
                                                <img src="{{ url('/images/brand/youtube.png') }}"
                                                    class="footer-icon" />
                                            </a>
                                        </span>
                                    @endif
                            ...
                            <tr>
                                <td class="content-block">
                                    <span class="apple-link"><a style="color: inherit;"
                                            href="mailto:{{ config('config.general.app_email') }}">{{ config('config.general.app_email') }}</a>
                                        | <a style="color: inherit;"
                                            href="{{ config('config.general.app_website') }}">{{ config('config.general.app_website') }}</a>
                                        | {{ config('config.general.app_phone') }}</span>
                                </td>
                            </tr>
                            <tr>
