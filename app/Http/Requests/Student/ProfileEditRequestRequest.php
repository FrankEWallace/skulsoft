...
class ProfileEditRequestRequest extends FormRequest
{
    ...
    public function rules()
    {
        $rules = [
            ...
            'father_birth_date' => ['nullable', 'date_format:Y-m-d', 'before:today'],
            'father_occupation' => ['nullable', 'string', 'max:100'],
            'father_annual_income' => ['nullable', 'string', 'max:100'],
            'mother_email' => ['nullable', 'email'],
            'mother_birth_date' => ['nullable', 'date_format:Y-m-d', 'before:today'],
            'mother_occupation' => ['nullable', 'string', 'max:100'],
            'mother_annual_income' => ['nullable', 'string', 'max:100'],
    ...
    public function attributes()
    {
        return [
            ...
            'father_contact_number' => __('contact.props.father_contact_number'),
            'father_email' => __('contact.props.father_email'),
            'father_birth_date' => __('contact.props.birth_date'),
            'father_occupation' => __('contact.props.occupation'),
            'father_annual_income' => __('contact.props.annual_income'),
            'mother_contact_number' => __('contact.props.mother_contact_number'),
            'mother_email' => __('contact.props.mother_email'),
            'mother_birth_date' => __('contact.props.birth_date'),
            'mother_occupation' => __('contact.props.occupation'),
            'mother_annual_income' => __('contact.props.annual_income'),
            ...
            'unique_id_number4' => config('config.contact.unique_id_number4_label'),
            'unique_id_number5' => config('config.contact.unique_id_number5_label'),
