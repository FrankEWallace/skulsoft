...
class FeeStructure extends Model
{
    ...
    {
        return $this->hasMany(FeeAllocation::class, 'fee_structure_id');
    }

    public function students(): HasMany
    {
        return $this->hasMany(Student::class, 'fee_structure_id');
    }
    ...
    public function scopeFindByUuidOrFail(Builder $query, ?string $uuid = null)
    {
        return $query
            ->byPeriod()
            ->whereUuid($uuid)
            ->getOrFail(trans('finance.fee_structure.fee_structure'));
    }
